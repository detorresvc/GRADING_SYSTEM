...
<?php echo  $this->Html->link(__('Print'), array('controller'=>'StudentRecordHeaders','action' => 'printgrade',  $details[0]['StudentRecordHeader']['id']));?>
&nbsp;&nbsp;&nbsp;
<?php echo  $this->Html->link(__('Update Check List'), array('controller'=>'StudentRecordHeaders','action' => 'updatechecklist'));?>
<script>
        function changeView(){
